...
Closed baselines and dated session records, moved out of `docs/STATUS.md` on 2026-08-16 so the live
handoff stays short enough to read whole. **Nothing here is current.** Read it only when you need
the history behind a decision; for the narrative form see `docs/iterations/`.
...
## Notes, 2026-08-04 to 2026-08-11

The session diary as it stood when it was moved out of `docs/STATUS.md` on 2026-08-16. Root causes
and traps, in the order they were found.
