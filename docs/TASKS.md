...
- [ ] **T099** — `README.md` — paths: `README.md`, `docs/qa/screenshots/**` — deps: T095, T098 — DoD: F48 met; Russian, per the owner; what the site is, screenshots of all four sections in both themes, the stack, quick start, how to run the tests including the exit-code trap, deployment, and links into `docs/`; screenshots captured from the running site by a Playwright script so they can be regenerated.
